...
t.login.password = '密碼'
t.login.captcha = '驗證碼'
t.login.demo = '滬ICP備案編號：滬ICP備16000880號-1'
t.login.copyright = 'Copyright ©1999-2017 上海農村產權交易所版權所有'
t.login.tech = '技術支持：無錫林盟科技有限公司'

t.home = {}
t.home.sysInfo = {}
t.home.sysInfo.name = '系統名稱'
t.home.sysInfo.nameVal = '上海農村產權交易所交易系統'
